 ...
 */
@Slf4j
public final class SiroiAssignmentHelper {

    /**
     * private Constructor
     */
    private SiroiAssignmentHelper() throws InitializationNotAllowedException {
        throw new InitializationNotAllowedException("Initialization not allowed");
    }

    /**
     * success param for view
     */
    public static final String SUCCESS = "success";

    /**
     * error param for view
     */
